...
#define REG_TIME_LIM         (0x3B)
#define REG_TIME_LAT         (0x3C)
#define REG_TIME_WND         (0x3D)
...
#define D4D_INT2    ((uint8_t)0x01)            //!< 4D enable on INT2*/
#define LIR_INT2    ((uint8_t)0x02)            //!< Latch interrupt request on INT2*/
#define D4D_INT1    ((uint8_t)0x04)            //!< 4D enable on INT1*/
#define LIR_INT1    ((uint8_t)0x08)            //!< Latch interrupt request on INT1*/
...
#define SRC_SCLICK  (1<<4)
#define SRC_DCLICK	(1<<5)
