...
{
    uint8_t battery_level = (uint8_t)200;
...
static void heart_rate_meas_timeout_handler(void * p_context)
{
    ...
    uint16_t heart_rate = (uint16_t)180/*sensorsim_measure(&m_heart_rate_sim_state, &m_heart_rate_sim_cfg)*/;
...
static void rr_interval_timeout_handler(void * p_context)
{
    ...
    if (m_rr_interval_enabled)
    {
        ...
        rr_interval = (uint16_t)100/*sensorsim_measure(&m_rr_interval_sim_state,
